    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$I, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React.createElement(Icon$K, { color: "currentColor", width: "24px" });
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$I, { color: "primary" })))),
...
var Logo = function (_a) {
    ...
    (React.createElement(React.Fragment, null,
        React.createElement(Icon$C, { className: "mobile-icon" }),
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$U, null) : React.createElement(Icon$V, null)),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://fantom.foundation", external: true },
            React.createElement(Icon$E, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$F, { width: "20px", color: "primary", ml: "4px" }),
...
export { Icon$Y as AddIcon, Alert, Icon$X as ArrowBackIcon, Icon$W as ArrowDownIcon, Icon$V as ArrowDropDownIcon, Icon$U as ArrowDropUpIcon, Icon$T as ArrowForwardIcon, Icon$S as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$R as BinanceIcon, Icon$_ as BlockIcon, Breadcrumbs, Icon$Q as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$O as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$P as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$10 as CheckmarkCircleIcon, Icon$N as CheckmarkIcon, Icon$M as ChevronDownIcon, Icon$L as ChevronLeftIcon, Icon$K as ChevronRightIcon, Icon$J as ChevronUpIcon, Icon$I as CloseIcon, Icon$H as CogIcon, Icon$G as CommunityIcon, Icon$F as CopyIcon, Dropdown, Icon$$ as ErrorIcon, Flex, Heading, Icon$E as HelpIcon, IconButton, Image, Icon$Z as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$D as ListViewIcon, Icon$C as LogoIcon, Icon$B as LogoRoundIcon, Menu, Icon$A as MinusIcon, Modal, ModalProvider, Icon$z as OpenNewIcon, Icon$x as PancakeRoundIcon, Icon$y as PancakesIcon, Icon$v as PrizeIcon, Progress, Icon$s as ProgressBunny, Radio, Icon$u as RemoveIcon, ResetCSS, Icon$w as SYFRoundIcon, Icon$o as SearchIcon, Skeleton, Spinner, Svg, Icon$n as SwapVertIcon, Icon$m as SyncAltIcon, Tag, Text, Icon$q as Ticket, Icon$p as TicketRound, ToastContainer, Toggle, Icon$t as VerifiedIcon, Icon$l as WarningIcon, Icon$r as Won, variants as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
